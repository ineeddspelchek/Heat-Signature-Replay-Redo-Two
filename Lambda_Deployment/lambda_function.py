...
def edit(times, key, s3client): #create and edit raw footage from speed change timestamps
    pauseOffset = -.04 #how much earlier to start pause to make sure its frames aren't included
    unpauseOffset = .03 #how much later to end unpause to make sure its frames aren't included
